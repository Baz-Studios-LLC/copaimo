...
| AQ-034 | P0 | Editor/settlement sculpt coherence | User reports that lowering terrain under a city leaves streets and buildings hanging above the sculpted hollow. This makes the editor visually dishonest over settlements and blocks terrain-led city composition. | needs review | Diagnose whether settlement heights are cached/generated independently of edited ground or the editor omits dependent regeneration. Either make visible surface, traversal/collision and placed settlement elements follow the same edit, or explicitly prevent/communicate unsupported settlement sculpting. Prove with identical before/after city views and height samples. |
