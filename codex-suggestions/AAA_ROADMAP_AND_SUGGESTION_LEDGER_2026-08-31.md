...
| AQ-021 | P0 | Ink regression | `faa26a9` commits `much * 0.0` in the final ink blend, globally disabling screen-space outlines. | needs review | Restore the nonzero blend and add a standing nonzero-coverage check before accepting further visual evidence. |
