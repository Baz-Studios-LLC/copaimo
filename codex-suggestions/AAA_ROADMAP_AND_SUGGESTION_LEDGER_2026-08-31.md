...
| AQ-029 | P1 | Building/prop QC | Dimensional audit found the townhouse stair climbs 3.6 m in ten 0.36 m risers over 0.28 m goings, has no rail/guard, and appears to terminate beneath an unbroken upper-floor slab. Old-world doors also display a 1.615 m-wide single leaf in a 1.90 x 2.45 m portal, and city-yard kerbs stand 0.34/0.26 m against the road kerb's 0.22 m. | needs review | Photograph and drive the stair, including a section/collision comparison; make a warden-to-door fixed-view sheet; traverse/profile both yard kerbs. Preserve intentional camera clearance, but make the visible construction explain it. |
