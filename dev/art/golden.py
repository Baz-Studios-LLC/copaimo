...
SHEET = (
    ...
    ("foot_L_jog", ["--clip", "jog", "--frame", "23", "--only", "foot_L_side"]),
    ("foot_R_jog", ["--clip", "jog", "--frame", "10", "--only", "foot_R_side"]),
    ...
    ("jog_worst", ["--clip", "jog", "--frame", "10", "--only", "quarter"]),
    ("jog_worst_front", ["--clip", "jog", "--frame", "10", "--only", "front"]),
)
